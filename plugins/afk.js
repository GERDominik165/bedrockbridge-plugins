...
world.afterEvents.playerSpawn.subscribe(e=>{ if(!e?.player || !e.player.id) return; // skip SimulatedPlayers
    if (e.initialSpawn) return;

    player_stats.set(e.player.id, new PlayerStats(e.player));
})

world.afterEvents.playerLeave.subscribe(e=>{ if(!e?.playerName) return;
