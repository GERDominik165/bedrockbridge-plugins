...
export const API_ENDPOINTS = {
    ...
    // Files
    FILES_LIST: (id, dir = '/') => `/api/client/servers/${id}/files/list?directory=${encodeURIComponent(dir)}`,
    FILES_CONTENTS: (id, file) => `/api/client/servers/${id}/files/contents?file=${encodeURIComponent(file)}`,
    FILES_WRITE: (id, file) => `/api/client/servers/${id}/files/write?file=${encodeURIComponent(file)}`,
    FILES_UPLOAD: (id, dir = '/') => `/api/client/servers/${id}/files/upload?directory=${encodeURIComponent(dir)}`,
    FILES_DELETE: (id) => `/api/client/servers/${id}/files/delete`,
    FILES_CREATE_FOLDER: (id) => `/api/client/servers/${id}/files/create-folder`,
    ...
    DATABASE_DETAILS: (id, dbId) => `/api/client/servers/${id}/databases/${dbId}`,
    DATABASE_ROTATE_PASSWORD: (id, dbId) => `/api/client/servers/${id}/databases/${dbId}/rotate-password`,
    // Backups
    BACKUPS: (id) => `/api/client/servers/${id}/backups`,
    BACKUP_DETAILS: (id, backupId) => `/api/client/servers/${id}/backups/${backupId}`,
    ...
    SCHEDULE_DETAILS: (id, schedId) => `/api/client/servers/${id}/schedules/${schedId}`,
    ...
    ALLOCATION_PRIMARY: (id, allocId) => `/api/client/servers/${id}/network/allocations/${allocId}/primary`,
    // Users
    USERS: (id) => `/api/client/servers/${id}/users`,
    USER_DETAILS: (id, userId) => `/api/client/servers/${id}/users/${userId}`,
    // Account
