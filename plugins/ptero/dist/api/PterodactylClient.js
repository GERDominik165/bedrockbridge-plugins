...
import { ApiError, NetworkError, TimeoutError, PterodactylError } from '../utils/ErrorHandler';
...
export class PterodactylClient {
     ...
     */
    async request(endpoint, method, body, overrideMethod) {
        // Check rate limits
     ...
     */
    async executeRequest(endpoint, method, body, overrideMethod) {
        let lastError = null;
     ...
     */
    cancelAllRequests(reason = 'Client shutdown') {
