...
try {
  _bridgeHub.register({ id: "ranks", title: "🎖️ Ränge", icon: "textures/items/name_tag", category: "Verwaltung", order: 10, permission: settings.admin_tag, handler: openMainMenu });
