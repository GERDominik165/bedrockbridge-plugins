...
// ================== EXPORTS ==================
export { ScheduleManager, Schedule, UIManager };


// --- Reparatur: Stubs für Methoden aus dem entfernten korrupten Schwanz ---
if (typeof UIManager !== "undefined" && !UIManager.showScheduleHistory) { UIManager.showScheduleHistory = async function(player) { try { player.sendMessage(`${CONFIG.ui.warning_color}[Schedule] „showScheduleHistory" ist in dieser Version vereinfacht.`); UIManager.showMainMenu(player); } catch (e) {} }; }
if (typeof UIManager !== "undefined" && !UIManager.showAdminPanel) { UIManager.showAdminPanel = async function(player) { try { player.sendMessage(`${CONFIG.ui.warning_color}[Schedule] „showAdminPanel" ist in dieser Version vereinfacht.`); UIManager.showMainMenu(player); } catch (e) {} }; }
if (typeof UIManager !== "undefined" && !UIManager.showTemplates) { UIManager.showTemplates = async function(player) { try { player.sendMessage(`${CONFIG.ui.warning_color}[Schedule] „showTemplates" ist in dieser Version vereinfacht.`); UIManager.showMainMenu(player); } catch (e) {} }; }
if (typeof UIManager !== "undefined" && !UIManager.cleanupOldData) { UIManager.cleanupOldData = async function(player) { try { player.sendMessage(`${CONFIG.ui.warning_color}[Schedule] „cleanupOldData" ist in dieser Version vereinfacht.`); UIManager.showMainMenu(player); } catch (e) {} }; }
if (typeof UIManager !== "undefined" && !UIManager.showHelp) { UIManager.showHelp = async function(player) { try { player.sendMessage(`${CONFIG.ui.warning_color}[Schedule] „showHelp" ist in dieser Version vereinfacht.`); UIManager.showMainMenu(player); } catch (e) {} }; }
